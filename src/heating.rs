...
{   
    ...
    pub fn update(&mut self, command: Option<Command<DURATION>>, delta_t: DURATION, power: i32, noise_level: i32, overload_level: i32) {
        ...
        self.state.update(delta_t, power < overload_level || self.drive_time <= self.allowed_overload_duration);        
